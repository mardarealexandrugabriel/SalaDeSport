<%@ Page Title="" Language="C#" MasterPageFile="~/Master.Master" AutoEventWireup="true" CodeBehind="EditTraining.aspx.cs" Inherits="SalaDeSport.EditTraining" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
     <div class="container">
        <div class="row">
            <div class="panel panel-info">
                <div class="panel-heading">
                   <h3 id="PanelTitle" runat="server">
                   </h3>
                </div>
                <div class="panel-body">
                    <div class="col-lg-3">
                        <div class="panel panel-info">
                            <div class="panel-heading">Edit Time And Name of the training</div>
                            <div class="panel-body">
                                <div class="form-group">
                                     <label for="HourOT">Training Hour</label>
                                    <input type="number" runat="server" id="HourOT" class="form-control"  min="0" max="23" />
                                </div>
                                <div class="form-group">
                                ...
                                <div class="btn-group">
                                    <input type="submit" onserverclick="SubmitClick" runat="server" class="btn btn-success" value="Save"  />
                        ...
                        <div class="panel panel-info collapse" id="AddExerciseCollapse">
                            ...
                            <div class="panel-body">
                                ...
                                <div class="form-group">
                                    <input type="button" runat="server" id="AddExerciceButton" onserverclick="AddExerciseButtonClick" class="btn btn-success" value="Add new Execise" />
